...
@Entity
@Table(name = "\"hkrbudgetingdb.db.dbmodel::hkrbudgeting.Title\"")
public class TitleEntity implements Serializable {

  private static final long serialVersionUID = 1L;

  @Id
  @SequenceGenerator(name = "S_Title", sequenceName = "\"hkrbudgetingdb.db::S_Title\"", allocationSize = 1)
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "S_Title")
  private Long id;
