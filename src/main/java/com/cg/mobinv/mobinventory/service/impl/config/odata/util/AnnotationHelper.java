...
public class AnnotationHelper {
  ...
  public boolean keyMatch(final Object firstInstance, final Object secondInstance) {
    ...
    if (firstKeyFields.isEmpty() && secondKeyFields.isEmpty()) {
      throw new AnnotationRuntimeException("Both object instances does not have EdmKey fields defined [" + "firstClass="
  ...
  public class AnnotatedNavInfo {
    ...
    public String toString() {
      ...
      if (isBiDirectional()) {
        return "AnnotatedNavInfo{biDirectional = true" + ", toField=" + this.toField.getName() + ", toNavigation="
  ...
  private Object convert(final Field field, final String propertyValue) {
    ...
    try {
      ...
      throw new AnnotationRuntimeException("Conversion failed for string property [" + propertyValue + "] on field ["
